  ...
  Future<void> hydrateFromServer() async {
    try {
      ...
      state = state.copyWith(
        ...
        rcBackUrl: hydrated.rcBackUrl ?? state.rcBackUrl,
        insuranceUrl: hydrated.insuranceUrl ?? state.insuranceUrl,
        pollutionUrl: hydrated.pollutionUrl ?? state.pollutionUrl,
        permitUrl: hydrated.permitUrl ?? state.permitUrl,
        fitnessUrl: hydrated.fitnessUrl ?? state.fitnessUrl,
        vehicleFrontUrl: hydrated.vehicleFrontUrl ?? state.vehicleFrontUrl,
        vehicleBackUrl: hydrated.vehicleBackUrl ?? state.vehicleBackUrl,
        vehicleSideUrl: hydrated.vehicleSideUrl ?? state.vehicleSideUrl,
