...
// Step 1 - Personal
 String get fullName; String get phone; String get email;@JsonKey(name: 'date_of_birth') String? get dateOfBirth; String? get gender;@JsonKey(name: 'referral_code') String? get referralCode;// Step 2 - Address
...
@JsonKey(name: 'selfie_url') String? get selfieUrl;// Step 7 - Bank
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,fullName,phone,email,dateOfBirth,gender,referralCode,country,state,city,pinCode,currentAddress,licenseNumber,licenseIssueDate,licenseExpiryDate,licenseFrontUrl,licenseBackUrl,vehicleType,vehicleNumber,vehicleBrand,vehicleModel,vehicleColor,manufacturingYear,rcUrl,insuranceUrl,pollutionUrl,permitUrl,fitnessUrl,vehicleFrontUrl,vehicleBackUrl,vehicleSideUrl,selfieUrl,accountHolder,accountNumber,ifsc,bankName,upiId]);

@override
String toString() {
  return 'DriverRegistration(fullName: $fullName, phone: $phone, email: $email, dateOfBirth: $dateOfBirth, gender: $gender, referralCode: $referralCode, country: $country, state: $state, city: $city, pinCode: $pinCode, currentAddress: $currentAddress, licenseNumber: $licenseNumber, licenseIssueDate: $licenseIssueDate, licenseExpiryDate: $licenseExpiryDate, licenseFrontUrl: $licenseFrontUrl, licenseBackUrl: $licenseBackUrl, vehicleType: $vehicleType, vehicleNumber: $vehicleNumber, vehicleBrand: $vehicleBrand, vehicleModel: $vehicleModel, vehicleColor: $vehicleColor, manufacturingYear: $manufacturingYear, rcUrl: $rcUrl, insuranceUrl: $insuranceUrl, pollutionUrl: $pollutionUrl, permitUrl: $permitUrl, fitnessUrl: $fitnessUrl, vehicleFrontUrl: $vehicleFrontUrl, vehicleBackUrl: $vehicleBackUrl, vehicleSideUrl: $vehicleSideUrl, selfieUrl: $selfieUrl, accountHolder: $accountHolder, accountNumber: $accountNumber, ifsc: $ifsc, bankName: $bankName, upiId: $upiId)';
}
...
@useResult
$Res call({
 String fullName, String phone, String email,@JsonKey(name: 'date_of_birth') String? dateOfBirth, String? gender,@JsonKey(name: 'referral_code') String? referralCode, String? country, String? state, String? city,@JsonKey(name: 'pin_code') String? pinCode,@JsonKey(name: 'current_address') String? currentAddress,@JsonKey(name: 'license_number') String? licenseNumber,@JsonKey(name: 'license_issue_date') String? licenseIssueDate,@JsonKey(name: 'license_expiry_date') String? licenseExpiryDate,@JsonKey(name: 'license_front_url') String? licenseFrontUrl,@JsonKey(name: 'license_back_url') String? licenseBackUrl,@JsonKey(name: 'vehicle_type') String? vehicleType,@JsonKey(name: 'vehicle_number') String? vehicleNumber,@JsonKey(name: 'vehicle_brand') String? vehicleBrand,@JsonKey(name: 'vehicle_model') String? vehicleModel,@JsonKey(name: 'vehicle_color') String? vehicleColor,@JsonKey(name: 'manufacturing_year') int? manufacturingYear,@JsonKey(name: 'rc_url') String? rcUrl,@JsonKey(name: 'insurance_url') String? insuranceUrl,@JsonKey(name: 'pollution_url') String? pollutionUrl,@JsonKey(name: 'permit_url') String? permitUrl,@JsonKey(name: 'fitness_url') String? fitnessUrl,@JsonKey(name: 'vehicle_front_url') String? vehicleFrontUrl,@JsonKey(name: 'vehicle_back_url') String? vehicleBackUrl,@JsonKey(name: 'vehicle_side_url') String? vehicleSideUrl,@JsonKey(name: 'selfie_url') String? selfieUrl,@JsonKey(name: 'account_holder') String? accountHolder,@JsonKey(name: 'account_number') String? accountNumber, String? ifsc,@JsonKey(name: 'bank_name') String? bankName,@JsonKey(name: 'upi_id') String? upiId
});
...
as int?,rcUrl: freezed == rcUrl ? _self.rcUrl : rcUrl // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _DriverRegistration() when $default != null:
return $default(_that.fullName,_that.phone,_that.email,_that.dateOfBirth,_that.gender,_that.referralCode,_that.country,_that.state,_that.city,_that.pinCode,_that.currentAddress,_that.licenseNumber,_that.licenseIssueDate,_that.licenseExpiryDate,_that.licenseFrontUrl,_that.licenseBackUrl,_that.vehicleType,_that.vehicleNumber,_that.vehicleBrand,_that.vehicleModel,_that.vehicleColor,_that.manufacturingYear,_that.rcUrl,_that.insuranceUrl,_that.pollutionUrl,_that.permitUrl,_that.fitnessUrl,_that.vehicleFrontUrl,_that.vehicleBackUrl,_that.vehicleSideUrl,_that.selfieUrl,_that.accountHolder,_that.accountNumber,_that.ifsc,_that.bankName,_that.upiId);case _:
  return orElse();
...
class _DriverRegistration implements DriverRegistration {
  const _DriverRegistration({this.fullName = '', this.phone = '', this.email = '', @JsonKey(name: 'date_of_birth') this.dateOfBirth, this.gender, @JsonKey(name: 'referral_code') this.referralCode, this.country, this.state, this.city, @JsonKey(name: 'pin_code') this.pinCode, @JsonKey(name: 'current_address') this.currentAddress, @JsonKey(name: 'license_number') this.licenseNumber, @JsonKey(name: 'license_issue_date') this.licenseIssueDate, @JsonKey(name: 'license_expiry_date') this.licenseExpiryDate, @JsonKey(name: 'license_front_url') this.licenseFrontUrl, @JsonKey(name: 'license_back_url') this.licenseBackUrl, @JsonKey(name: 'vehicle_type') this.vehicleType, @JsonKey(name: 'vehicle_number') this.vehicleNumber, @JsonKey(name: 'vehicle_brand') this.vehicleBrand, @JsonKey(name: 'vehicle_model') this.vehicleModel, @JsonKey(name: 'vehicle_color') this.vehicleColor, @JsonKey(name: 'manufacturing_year') this.manufacturingYear, @JsonKey(name: 'rc_url') this.rcUrl, @JsonKey(name: 'insurance_url') this.insuranceUrl, @JsonKey(name: 'pollution_url') this.pollutionUrl, @JsonKey(name: 'permit_url') this.permitUrl, @JsonKey(name: 'fitness_url') this.fitnessUrl, @JsonKey(name: 'vehicle_front_url') this.vehicleFrontUrl, @JsonKey(name: 'vehicle_back_url') this.vehicleBackUrl, @JsonKey(name: 'vehicle_side_url') this.vehicleSideUrl, @JsonKey(name: 'selfie_url') this.selfieUrl, @JsonKey(name: 'account_holder') this.accountHolder, @JsonKey(name: 'account_number') this.accountNumber, this.ifsc, @JsonKey(name: 'bank_name') this.bankName, @JsonKey(name: 'upi_id') this.upiId});
...
@JsonKey(name: 'today_earnings') double get todayEarnings;@JsonKey(name: 'wallet_balance') double get walletBalance;@JsonKey(name: 'completed_trips') int get completedTrips;@JsonKey(name: 'today_trips') int get todayTrips; double get rating;@JsonKey(name: 'acceptance_rate') double get acceptanceRate;@JsonKey(name: 'cancellation_rate') double get cancellationRate;@JsonKey(name: 'current_location') String? get currentLocation;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,todayEarnings,walletBalance,completedTrips,todayTrips,rating,acceptanceRate,cancellationRate,currentLocation);

@override
String toString() {
  return 'DashboardStats(todayEarnings: $todayEarnings, walletBalance: $walletBalance, completedTrips: $completedTrips, todayTrips: $todayTrips, rating: $rating, acceptanceRate: $acceptanceRate, cancellationRate: $cancellationRate, currentLocation: $currentLocation)';
}
...
@useResult
$Res call({
@JsonKey(name: 'today_earnings') double todayEarnings,@JsonKey(name: 'wallet_balance') double walletBalance,@JsonKey(name: 'completed_trips') int completedTrips,@JsonKey(name: 'today_trips') int todayTrips, double rating,@JsonKey(name: 'acceptance_rate') double acceptanceRate,@JsonKey(name: 'cancellation_rate') double cancellationRate,@JsonKey(name: 'current_location') String? currentLocation
});
...
/// Create a copy of DashboardStats
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? todayEarnings = null,Object? walletBalance = null,Object? completedTrips = null,Object? todayTrips = null,Object? rating = null,Object? acceptanceRate = null,Object? cancellationRate = null,Object? currentLocation = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'today_earnings')  double todayEarnings, @JsonKey(name: 'wallet_balance')  double walletBalance, @JsonKey(name: 'completed_trips')  int completedTrips, @JsonKey(name: 'today_trips')  int todayTrips,  double rating, @JsonKey(name: 'acceptance_rate')  double acceptanceRate, @JsonKey(name: 'cancellation_rate')  double cancellationRate, @JsonKey(name: 'current_location')  String? currentLocation)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DashboardStats() when $default != null:
return $default(_that.todayEarnings,_that.walletBalance,_that.completedTrips,_that.todayTrips,_that.rating,_that.acceptanceRate,_that.cancellationRate,_that.currentLocation);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'today_earnings')  double todayEarnings, @JsonKey(name: 'wallet_balance')  double walletBalance, @JsonKey(name: 'completed_trips')  int completedTrips, @JsonKey(name: 'today_trips')  int todayTrips,  double rating, @JsonKey(name: 'acceptance_rate')  double acceptanceRate, @JsonKey(name: 'cancellation_rate')  double cancellationRate, @JsonKey(name: 'current_location')  String? currentLocation)  $default,) {final _that = this;
switch (_that) {
case _DashboardStats():
return $default(_that.todayEarnings,_that.walletBalance,_that.completedTrips,_that.todayTrips,_that.rating,_that.acceptanceRate,_that.cancellationRate,_that.currentLocation);case _:
  throw StateError('Unexpected subclass');
...
/// Create a copy of DashboardStats
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? todayEarnings = null,Object? walletBalance = null,Object? completedTrips = null,Object? todayTrips = null,Object? rating = null,Object? acceptanceRate = null,Object? cancellationRate = null,Object? currentLocation = freezed,}) {
