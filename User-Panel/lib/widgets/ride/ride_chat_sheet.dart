...
import 'package:wavego_user/services/ride_chat_service.dart';
...
class _RideChatSheetState extends ConsumerState<_RideChatSheet> {
  ...
  Future<void> _send() async {
    ...
    final optimistic = RideChatMessage(
      ...
      senderId: 'me',
      senderType: widget.mySenderType,
      message: text,
      senderName: 'You',
    );
    _controller.clear();
                      ...
                      : _messages.isEmpty
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final mine = msg.senderType == widget.mySenderType;
                                return Align(
