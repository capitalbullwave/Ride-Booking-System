...
export const accountProfileHub: HelpArticle = {
  ...
  children: [
    ...
    {
      id: "lost-phone",
      title: "I lost my phone in WaveGo",
      kind: "content",
      paragraphs: [
  ...
  children: [
    {
      ...
      kind: "content",
      paragraphs: [
        "Add or manage cash, UPI, cards, and WaveGo Wallet from the Wallet page.",
      ],
    ...
    },
    {
      ...
      kind: "content",
      paragraphs: [
        "Redeem gift cards in Wallet. Enter the code under WaveGo Cash to add balance.",
      ],
    },
    {
      id: "promos",
    ...
    },
    {
      ...
      kind: "content",
      paragraphs: [
        "WaveGo Cash is your in-app wallet balance for rides and deliveries.",
  ...
  children: [
    {
      ...
      kind: "content",
      paragraphs: [
        "Learn how WaveGo protects riders, captains, and patients on every trip and emergency request.",
      ],
  ...
  children: [
    {
      ...
      kind: "content",
      paragraphs: [
        "Book emergency medical transport through WaveGo Ambulance. For life-threatening situations, also call 112.",
      ],
  ...
  children: [
    {
      ...
      kind: "content",
      paragraphs: [
        "Download WaveGo, enter your phone number, verify OTP, and complete your profile to start booking.",
      ],
    },
    {
      id: "getting-started",
    ...
    {
      id: "how-wavego-works",
      title: "How WaveGo works",
      kind: "content",
      paragraphs: [
        "WaveGo connects you with nearby captains for rides, deliveries, and emergency ambulance services in real time.",
      ],
    },
    {
...
export const guidesServicesHub: HelpArticle = {
  id: "wavego-services",
  title: "WaveGo services",
  kind: "hub",
  children: [
    {
      id: "wavego-delivery",
      title: "WaveGo for delivery",
      kind: "content",
      paragraphs: [
    ...
    {
      id: "business-travel",
      title: "WaveGo for business travel",
      kind: "content",
      paragraphs: [
    ...
    {
      id: "wavego-pet",
      title: "WaveGo Pet — a ride for all paws",
      kind: "content",
      paragraphs: [
  ...
  children: [
    {
      ...
      kind: "content",
      paragraphs: ["WaveGo support is available 24/7 for riders across India in English and Hindi."],
    },
    {
      id: "faq",
    ...
    },
    {
      ...
      kind: "content",
      paragraphs: [
        "Join the WaveGo team. Visit careers.wavego.in for open roles in engineering, operations, and support.",
      ],
    },
  ],
};
...
export const membershipOverviewHub: HelpArticle = {
  ...
  children: [
    {
      id: "wavego-plus",
      title: "WaveGo Plus membership",
      kind: "content",
      paragraphs: [
        "WaveGo Plus offers discounted rides, priority support, and exclusive promos for frequent riders.",
      ],
    },
    {
  ...
  children: [
    {
      ...
      kind: "content",
      paragraphs: [
        "WaveGo supports accessible vehicles where available. Enable accessibility preferences in Account Settings.",
    ...
    },
    {
      ...
      kind: "content",
      paragraphs: [
        "WaveGo is compatible with TalkBack (Android) and VoiceOver (iOS).",
  ...
  children: [
    {
      ...
      title: "Report a problem in the WaveGo map",
      kind: "content",
      paragraphs: [
    ...
    },
    {
      ...
      title: "Fix a business or landmark issue on WaveGo Maps",
      kind: "content",
      paragraphs: [
    ...
    },
    {
      ...
      title: "Fix an incorrect address on WaveGo Maps",
      kind: "content",
      paragraphs: [
    ...
    {
      id: "road-info",
      title: "Fix road information on WaveGo Maps",
      kind: "content",
      paragraphs: [
  ...
  children: [
    {
      ...
      kind: "content",
      paragraphs: [
        "Plan metro journeys with WaveGo transit integration. View routes, fares, and nearby stations.",
      ],
    },
    {
      id: "trains",
    ...
    },
    {
      ...
      kind: "content",
      paragraphs: [
        "Find intercity bus routes and book last-mile rides to bus terminals with WaveGo.",
      ],
    },
  ],
};
  ...
  children: [
    {
      ...
      kind: "content",
      paragraphs: [
        "Save on daily commutes with a WaveGo Commute Pass — fixed rides at a discounted rate for 30 days.",
  ...
  children: [
    {
      ...
      kind: "content",
      paragraphs: [
        "WaveGo is committed to resolving rider grievances fairly and promptly.",
