...
export const fareReviewArticles: HelpArticle[] = [
  ...
  },
  {
    ...
    kind: "content",
    paragraphs: ["When you request an Intercity Trip on WaveGo, please note:"],
    numberedList: [
  ...
  },
  {
    ...
    kind: "content",
    paragraphs: [
      "Rental trips allow you to rent a WaveGo for multiple hours, according to the package chosen by you. The pricing for an Hourly Rental trip depends on the package that you choose.",
  ...
  },
  {
    ...
    kind: "content",
    paragraphs: [
      "Rental trips allow you to rent a WaveGo for multiple hours, according to the package chosen by you.",
      "When you request a Rental Trip on WaveGo, please note:",
    ],
    numberedList: [
  ...
  },
  {
    ...
    kind: "report-form",
    paragraphs: [
      "This form is for reporting cases when your captain didn't complete the trip at the intended drop-off point entered by you in the WaveGo app.",
  ...
  children: [
    {
      ...
      paragraphs: [
        ...
        "WaveGo cannot guarantee item recovery but will assist with contact details.",
      ],
    },
    {
      id: "lost-item-tips",
  ...
  children: [
    {
      ...
      kind: "content",
      paragraphs: [
        "WaveGo Pool trips may include other riders along your route.",
  ...
  children: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Try an alternate payment method or WaveGo Cash to complete your booking.",
      ],
    },
    {
      id: "refund-status",
  ...
  children: [
    {
      ...
      kind: "content",
      paragraphs: [
        "WaveGo for Business offers centralized billing, route management, and employee dashboards.",
  ...
  children: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "For medical emergencies, call 112 in addition to using WaveGo ambulance services.",
      ],
