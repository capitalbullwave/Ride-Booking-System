...
export const blogPosts: BlogPost[] = [
  {
    ...
    title: "WaveGo Ambulance SOS: Emergency care, one tap away",
    excerpt:
      "We launched integrated ambulance booking so riders can request verified medical transport without leaving the WaveGo app.",
    category: "Product",
    date: "2026-05-12",
    readTime: "4 min read",
    image: landingHeroSlides[4].src,
    imageAlt: "WaveGo ambulance service",
    author: "WaveGo Team",
    paragraphs: [
      "Every second counts in a medical emergency. That is why WaveGo Ambulance SOS is built directly into the same app you use for rides and parcels — no separate downloads, no confusing flows.",
      "When you request an ambulance, WaveGo matches you with verified medical transport partners, shows live ETA, and shares trip details with your emergency contacts automatically.",
  ...
  },
  {
    ...
    title: "50 cities and counting: WaveGo's expansion across India",
    excerpt:
      "From a single-city pilot to a nationwide mobility network — how WaveGo is bringing reliable rides to more communities every month.",
    category: "Company",
    date: "2026-04-28",
    readTime: "5 min read",
    image: landingHeroSlides[3].src,
    imageAlt: "WaveGo fleet on Indian roads",
    author: "Priya Sharma",
    paragraphs: [
      "WaveGo started with a simple belief: Indian cities deserve mobility that is fast, fair, and safe. Today we operate in over 50 cities, connecting millions of rides, parcels, and emergency trips each quarter.",
  ...
  },
  {
    ...
    title: "Transparent earnings: What WaveGo captains actually take home",
    excerpt:
      "No hidden cuts, no surprise deductions — a clear look at how captain payouts work on WaveGo.",
    category: "Captains",
    date: "2026-04-10",
    readTime: "6 min read",
    image: landingCaptainImage,
    imageAlt: "WaveGo captain partner",
    author: "Rahul Kapoor",
    paragraphs: [
      "Captains are the backbone of WaveGo. We heard loud and clear that unclear earnings were the number-one frustration on other platforms — so we rebuilt payouts from the ground up.",
      ...
      "If you are considering driving with WaveGo, visit the Captains section on our homepage or sign in to explore partner onboarding in your city.",
    ],
  },
  {
    slug: "monsoon-ride-safety-tips",
    title: "7 monsoon ride safety tips every WaveGo rider should know",
    excerpt:
    ...
    imageAlt: "Safe WaveGo ride in the city",
    author: "WaveGo Safety Team",
    paragraphs: [
      "Monsoon season brings flooded roads, reduced visibility, and longer trip times. WaveGo adjusts ETAs for weather, but a few habits from you make every ride safer.",
  ...
  },
  {
    ...
    title: "One million parcels delivered: WaveGo Parcel hits a milestone",
    excerpt:
      "Same-day intra-city delivery is now a core part of how businesses and families move goods across WaveGo cities.",
    category: "Product",
    date: "2026-03-05",
    readTime: "4 min read",
    image: landingHeroSlides[2].src,
    imageAlt: "WaveGo parcel delivery",
    author: "WaveGo Team",
    paragraphs: [
      "WaveGo Parcel crossed one million completed deliveries this quarter — documents, gifts, pharmacy runs, and small business shipments that needed to move fast within the city.",
  ...
  },
  {
    ...
    excerpt:
      "Dedicated safety features, training, and support channels designed for women on both sides of every WaveGo trip.",
    category: "Community",
    date: "2026-02-14",
    readTime: "5 min read",
    image: landingHeroSlides[1].src,
    imageAlt: "WaveGo community safety",
    author: "WaveGo Safety Team",
    paragraphs: [
      "Women make up a growing share of WaveGo riders and captains. Their safety is not an add-on feature — it is central to how we design products, policies, and support.",
