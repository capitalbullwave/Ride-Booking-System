...
const policySections: {
  ...
  },
  {
    ...
    points: [
      ...
      "Contact WaveGo support directly from the tracking screen.",
      ...
      <section className="relative overflow-hidden rounded-b-[32px] bg-primary px-5 pb-10 pt-5 text-white sm:px-8 md:px-12 md:pb-12 lg:px-16">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-white/80 sm:text-base">
            How WaveGo protects riders, captains, and patients across rides, deliveries, and
        ...
        <div className="flex gap-4 rounded-[20px] border border-error/25 bg-error/[0.04] p-5">
          ...
          <div>
            ...
            <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
              Call <strong className="text-foreground">112</strong> immediately. WaveGo ambulance
