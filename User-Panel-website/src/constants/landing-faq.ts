export const landingFaqItems = [
  {
    id: "book-ride",
    question: "How do I book a ride on WaveGo?",
    answer:
  ...
  {
    id: "payment",
    question: "What payment methods does WaveGo accept?",
    answer:
      "Pay with WaveGo Wallet, UPI, debit or credit cards, and cash on select trips. Wallet top-ups and ride receipts are available in the app under Wallet and Activity.",
  },
  {
    id: "cities",
    question: "Is WaveGo available in my city?",
    answer:
      "WaveGo operates in 50+ cities across India and is expanding every month. Download the app or enter a location on the landing page to see available services in your area.",
  },
  {
    id: "ambulance",
    question: "How does Ambulance SOS work?",
    answer:
      "Tap Emergency on the booking widget or home screen, enter pickup and hospital or destination details, and confirm. WaveGo matches you with verified medical transport and shares live trip updates with your emergency contacts.",
  },
  {
    id: "parcel",
    question: "Can I send parcels through WaveGo?",
    answer:
  ...
  {
    id: "safety",
    question: "How does WaveGo keep rides safe?",
    answer:
  ...
  {
    id: "captain",
    question: "How do I become a WaveGo captain?",
    answer:
